...
var tableFolders = document.getElementById('table-folders');

// Loop tru accordions
triggerAccordions.forEach(trigger => {
    // Variables
    let btn = trigger.querySelector('.triggers-accordions');
    ...
    var headerContent = document.querySelectorAll('.triggers-accordions');

    // On click show content of accordion
